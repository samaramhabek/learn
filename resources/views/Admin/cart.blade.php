                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand"
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item"><a class="nav-link" href="{{route('my_cart')}}"> <i
                            ...
                            <li class="nav-item"><a class="nav-link" href="#!"> <i
                                        ...
                                        (0)</small></a></li>
                            <li class="nav-item"><a class="nav-link" href="#!"> <i
                                        class="fas fa-user me-1 text-gray fw-normal"></i> @if(Auth::check())
                                        {{Auth::user()->name}}
                                        ...
                                        <div class="col-sm-7">
                                            <div
                                                ...
                                                <div class="quantity">
                                                    ...
                                                    <input class="form-control border-0 shadow-0 p-0 quantity" type="text"
                                                        value="1">
            ...
            <section class="py-5 bg-light">
                <div class="container">
                    <div class="row px-4 px-lg-5 py-lg-4 align-items-center">
                        <div class="col-lg-6">
                          <a href="{{route('my_cart')}}">  <h1 class="h2 text-uppercase mb-0">Cart</h1></a>
                        </div>
                                ...
                                <tbody class="border-0">
                                    ...
                                    @foreach ($cart as $item)
                                        <tr>
                                            <th class="ps-0 py-3 border-light" scope="row">
                                                <div class="d-flex align-items-center"><a
                                                        ...
                                                        href="detail.html"><img
                                                            src="{{ asset('imagesproduct/' . $item->product->imagesproduct->first()->image) }}"
                                                            alt="..." width="70" /></a>
                                                    <div class="ms-3"><strong class="h6"><a
                                                                class="reset-anchor animsition-link"
                                                                href="detail.html">{{ $item->product->name }}</a></strong>
                                                    </div>
                                                </div>
                                            </th>
                                            <td class="p-3 align-middle border-light  ">
                                                <p class="mb-0 small" id="price-{{ $item->product->id }}">
                                            ...
                                            <td class="p-3 align-middle border-0">
                                                <div
                                                    ...
                                                    <div class="quantity">
                                                        <button class="dec-btn p-0"><i
                                                                class="fas fa-caret-left"></i></button>
                                                        <input class="quantity-input" id="inputField" type="number"
                                                            value="{{ $item->quantity }}" width="150px"
                                                             />
                                                        <button data-product-id="{{ $item->product->id }}" class="inc-btn p-0" data-id="{{ $item->id }}"><i
                                                                class="fas fa-caret-right"></i></button>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="total-price"
                                                    id="total-price-{{ $item->product->id }}">{{ $item->Total }}</p>
                                            </td>
                        ...
                        <div class="bg-light px-4 py-3">
                            <div class="row align-items-center text-center">
                                <div class="col-md-6 mb-3 mb-md-0 text-md-start"><a
                                        class="btn btn-link p-0 text-dark btn-sm" href="shop.html"><i
                                ...
                                <div class="col-md-6 text-md-end"><a class="btn btn-outline-dark btn-sm"
                                        href="{{url('order')}}">Procceed to checkout<i
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="d-flex align-items-center justify-content-between"><strong
                                            ...
                                            class="text-muted small final_total">${{$final_total}}</span></li>
        ...
        {{-- <script>
            $(document).ready(function() {
                ...
                $('.quantity-input').on('input', function() {
                    ...
                    var price = parseFloat($('#price-' + productId).data('price-per-unit'));
             ...
             $(".final_total").html('');
                $.ajax({
                    ...
                    success: function(res) {
                       console.log('#total-price-' + product_id)
                       $('#total-price-' + product_id).html(res.total);
                                       
                       $(".moaz").html(res.total);
                       $(".final_total").html(res.all_total);
                     
    //                     var totalPriceSpan = document.getElementById('total-price-' + product_id);
    //    totalPriceSpan.textContent = res.total;
                    },
                });
            })
            })
...
var incrementBtn = document.querySelector('.inc-btn');
...
{{-- <script>
   // Get the increment button element
var incrementBtn = document.getElementsByClassName('inc-btn')[0];

// Add event listener to the increment button
incrementBtn.addEventListener('click', function() {
  // Get the associated input field
  var inputField = document.getElementsByClassName('quantity-input')[0];
