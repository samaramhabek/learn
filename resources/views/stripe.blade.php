...
$(function() {
    var stripe = Stripe('pk_test_51NZULnGUj5L3qAnS5kdVYEkIO3D8o5FoZ2RpPzUT1jnhdHe4dQEFH5tcch7UuGKIJogKEyHOqeGAjwefeQ6nZhXv000FExDEEZ');
  ...
  $('form.require-validation').bind('submit', function(e) {
    ...
    if (!$form.data('cc-on-file')) {
      e.preventDefault();
      Stripe.setPublishableKey($form.data(stripe));
      Stripe.createToken({
